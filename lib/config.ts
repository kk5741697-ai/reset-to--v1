...
export const APP_CONFIG = {
  ...
  enablePersistentAds: true, // Prevent duplicate ad loading
  enableContentQuality: true, // Enhanced content for approval
  ...
  enableProfessionalContent: true,
  enableIndustryContent: true,
