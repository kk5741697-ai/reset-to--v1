...
import { Braces, Code, CheckCircle, Archive, Eye } from "lucide-react"
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <div className="inline-flex items-center space-x-2 mb-4">
              ...
              <h1 className="text-3xl lg:text-4xl font-heading font-bold text-foreground">Professional JSON Formatter & Validator</h1>
            </div>
          ...
          <div className="max-w-5xl mx-auto mb-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <p className="text-sm text-gray-600">
                  See real-time formatting results with instant validation and error highlighting.
                </p>
              </div>
            </div>
